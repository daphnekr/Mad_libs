...
<head>
    ...
    <body>
        ...
        <form action="onkunde.php" method="post">
            Wat zou je graag willen kunnen? <input type="text" name="kunnen" required><br><br>

            Met welk persoon kun je goed opschieten? <input type="text" name="persoon" required><br><br>
